...
const allTags = ['Account', 'Call Forward', 'Billing', 'Number', 'Cost Cutting']
</script>
  ...
  <main class="container max-w-6xl mx-auto text-zinc-600">
    ...
    <div class="px-6">
      <input
        ...
        placeholder="Search"
        type="text"
        class="block w-full bg-[#F1F2F4] dark:bg-slate-900 dark:placeholder-zinc-500 text-zinc-600  rounded-md border-gray-300 dark:border-gray-800 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
      >
    </div>
      ...
      <div class="col-span-2">
        <div class="flex flex-wrap gap-3 m-2">
          <HelpCard
            ...
            :key="topic"
            :title="makeFirstCharUpper(topic)"
          />
        </div>
      </div>
      <div class="space-y-5 col-span-6">
