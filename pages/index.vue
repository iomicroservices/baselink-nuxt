...
<template>
  <div class="page-container">
    ...
    <AFaqTemplateSide>
      ...
      <AFaqItem order="0" question="1" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="2" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="3" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="4" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="5" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="6" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="7" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="8" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="9" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="10" answer="It's only £11 a month. It comes with lots of free features." />
      <AFaqItem order="0" question="11" answer="It's only £11 a month. It comes with lots of free features." />
    </AFaqTemplateSide>


    <AProcessHowto title="How to book a trusted handyman">
      <AProcessItem name="Give us the details" stepNumber="1"
        description="Tell us about the job & when you'd like the handyman to come. We've got handymen available same-day" />
      <AProcessItem name="Complete payment" stepNumber="2"
        description="Pay with confidence through our secure payment portal to subscribe." />
      <AProcessItem name="Start taking calls" stepNumber="3"
        description="You're all set up and ready to connect with customers wherever you are." />
    </AProcessHowto>

    <ACtaSimple title="What are you waiting for?" button="Get a quote" path="/" />
