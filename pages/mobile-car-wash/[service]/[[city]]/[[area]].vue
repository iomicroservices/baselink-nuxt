...
const effectiveTitle = computed(() => {
    if (area.value) {
        return `${area.value.name}'s best mobile car washers`
    } else if (city.value) {
        return `${city.value.name}'s best mobile car washers`
    }
    return 'Brilliant mobile car washers'
})
...
const effectiveMetaDescription = computed(() => {
    if (area.value) {
        return `Professional mobile car wash services in ${area.value.name}, ${city.value.name}. Serving ${area.value.regionName} and surrounding areas.`
    } else if (city.value) {
        return `Professional mobile car wash services in ${city.value.name}.`
    }
    return 'Professional mobile car wash services provided by brilliant local cleaners.'
})
    ...
    <div class="page-container">
        <MainHeroCentred badge="Only £11/month • Unlimited minutes" :title="effectiveTitle + ' for the best prices!'"
            :description="(area
                ...
                : city
                    ...
                    : 'Your local mobile car wash service') + ' for the best prices!'"
        ...
        <section class="container mx-auto px-4 py-12">
            ...
            <p class="text-lg text-gray-600 dark:text-gray-300">
                ...
                <span v-else>
                    Your local mobile car wash service.
                </span>
            </p>
