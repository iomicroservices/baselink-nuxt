...
const formConfig = {
    taskOptions: {
        default: 'boiler-installation',
        type: 'objectSelect',
        label: 'Task',
        options: [
            { label: 'Boiler installation', value: 'boiler-installation' },
            { label: 'Boiler replacement', value: 'boiler-replacement' },
            { label: 'Boiler service', value: 'boiler-service' },
            { label: 'Gas safety certificate', value: 'gas-safety-certificate' },
            { label: 'Annual boiler service', value: 'annual-boiler-service' },
            { label: 'Thermostat repair & replacement', value: 'thermostat-repair-replacement' },
