...
const formConfig = {
    taskOptions: {
        default: 'cp12-certificates',
        type: 'objectSelect',
        label: 'Task',
        options: [
            { label: 'CP12 Certificates', value: 'cp12-certificates' },
            { label: 'Domestic EPC', value: 'domestic-epc' },
            { label: 'Non-Domestic EPC', value: 'non-domestic-epc' },
            { label: 'EICR Report', value: 'eicr-report' },
            { label: 'Fire Risk Assessments', value: 'fire-risk-assessments' },
