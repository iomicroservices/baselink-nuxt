...
<template>
    <header class="relative py-20 mx-auto bg-cover bg-center" :style="{ backgroundImage: `url(${ogImage})` }">
        <div class="container px-4 mx-auto relative">
            <div class="max-w-2xl mb-14 text-left">
                <!-- badge section START -->
                ...
                <div class="max-w-lg sm:max-w-xl lg:max-w-none mx-auto">
                    ...
                    <p class="dark:text-zinc-300 mx-auto mb-5 text-left">
                        {{ description }}
                    </p>
